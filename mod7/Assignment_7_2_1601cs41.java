...
public class Assignment_7_2_1601cs41
{
	public static void main(String[] args) 
	{
		Visit visit1 = new Visit("Saurav Tiwary", new Date());
		visit1.customer.setMemberType("Gold");
		...
		visit1.setServiceExpense(2000);
		visit1.setProductExpense(2500);
