...
class CurAcc extends Account
{
	...
	void withdraw(double amount)
	{
		...
		{
			System.out.println("Your left balance is below minimum required balance (" + Double.toString(fixAmount) + "), so extra service charge " + Double.toString(serCharge) + " is deducted from your account.");
...
public class Assignment_7_5_1601cs41
{
	public static void main(String[] args) 
	{
	// saving account		
		SavAcc sav1 = new SavAcc("Saurav", "108952455", 340000.0);
		...
		System.out.println();
	// current account		
		CurAcc curr1 = new CurAcc("Vatsa", "489690596465", 2000.0);
